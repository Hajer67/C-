...
namespace Projet_partie_2
{
    internal class Banque
    {
        ...
        public Banque()
        {
            _comptes = EntréesSorties.FichierComptes();
            _transactions = EntréesSorties.FichierTransactions(@"C:\Users\Formation\Desktop\C#\PartieI\Transactions_1.txt");
        }
        ...
        public void GestionTransactions()
        {
            ...
            EntréesSorties.fichierStatusTransactions(_transactions);
        }
